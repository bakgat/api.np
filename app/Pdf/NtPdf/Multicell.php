...
class Multicell
{
    ...
    {
        $this->oPdf = $oPdf;
        $this->oPdfi = new NtInterface($oPdf);
                              ...
                              $nPaddingBottom = 0, $rotate = 0)
    {
        ...
        do {
            ...
            $this->multiCellSec($nWidth, $nHeight, $aSendData, $border, $align, $fill, $nPaddingLeft, $nPaddingTop, $nPaddingRight, $nPaddingBottom, false, $rotate);
    ...
    public function multiCellSec($nWidth, $nHeight, $pData, $border = 0, $align = 'J', $fill = 0, $nPaddingLeft = 0, $nPaddingTop = 0, $nPaddingRight = 0,
                                 $nPaddingBottom = 0, $bDataIsString = true, $rotate = 0)
    {
        ...
        while (!$bLastLine) {
            ...
            $this->printLine($w_text, $nHeight, $str_data, $align, $rotate);
    ...
    protected function divideByTags($pStr)
    {
        ...
        $sWork = new Tags($this->nTagWidthMax);
     ...
     */
    protected function printLine($nWidth, $nHeight, $aTxt, $align = 'J', $rotate = 0)
    {
        if (0 == $nWidth) {
            $nWidth = $this->oPdfi->getRemainingWidth();
        }
