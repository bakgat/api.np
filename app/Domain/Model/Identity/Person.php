...
{
    /**
     * @Groups({"student_list", "student_detail", "staff_list", "group_students", "evaluation_detail"})
     *
     * @ORM\Id
    ...
    /**
     * @Groups({"student_list", "student_detail", "staff_list"})
     *
    ...
    /**
     * @Groups({"student_list", "student_detail",  "staff_list", "group_students"})
     *
     * @ORM\Column(type="string")
     * @var string
     */
