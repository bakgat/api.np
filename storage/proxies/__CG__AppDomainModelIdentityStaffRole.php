 ...
 */
class StaffRole extends \App\Domain\Model\Identity\StaffRole implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'staff', 'role', 'dateRange'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (StaffRole $proxy) {
