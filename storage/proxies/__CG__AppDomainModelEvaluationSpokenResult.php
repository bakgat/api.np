 ...
 */
class SpokenResult extends \App\Domain\Model\Evaluation\SpokenResult implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'evaluation', 'student', 'summary'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (SpokenResult $proxy) {
    ...
    public function updateSummary($summary)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'updateSummary', [$summary]);

        return parent::updateSummary($summary);
    }
