 ...
 */
class BranchForGroup extends \App\Domain\Model\Education\BranchForGroup implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (BranchForGroup $proxy) {
