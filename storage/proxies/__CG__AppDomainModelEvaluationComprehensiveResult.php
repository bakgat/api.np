 ...
 */
class ComprehensiveResult extends \App\Domain\Model\Evaluation\ComprehensiveResult implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'evaluation', 'student'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ComprehensiveResult $proxy) {
