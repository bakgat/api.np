 ...
 */
class FeedbackResult extends \App\Domain\Model\Evaluation\FeedbackResult implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (FeedbackResult $proxy) {
