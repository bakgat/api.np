 ...
 */
class PointResult extends \App\Domain\Model\Evaluation\PointResult implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'evaluation', 'student', 'score', 'redicodi'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (PointResult $proxy) {
    ...
    public function setRedicodi(array $redicodi)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setRedicodi', [$redicodi]);
