 ...
 */
class MultiplechoiceResult extends \App\Domain\Model\Evaluation\MultiplechoiceResult implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'evaluation', 'student', 'selected'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (MultiplechoiceResult $proxy) {
    ...
    public function update($selected)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'update', [$selected]);

        return parent::update($selected);
    }
