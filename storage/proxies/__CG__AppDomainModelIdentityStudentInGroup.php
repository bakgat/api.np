 ...
 */
class StudentInGroup extends \App\Domain\Model\Identity\StudentInGroup implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (StudentInGroup $proxy) {
