 ...
 */
class RedicodiForStudent extends \App\Domain\Model\Evaluation\RedicodiForStudent implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (RedicodiForStudent $proxy) {
    ...
    public function getRedicodi()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getRedicodi', []);

        return parent::getRedicodi();
    }
